...
export const translations = {
  en: {
    ...
    hero: {
      ...
      discover: "Discover Competitions",
      watch: "Watch Video"
    },
    filters: {
      title: "Competitions",
      subtitle: "Explore and apply for technology competitions.",
  ...
  tr: {
    ...
    filters: {
      title: "Yarışmalar",
      subtitle: "Teknoloji yarışmalarını keşfedin ve başvurun.",
      searchPlaceholder: "Yarışma ara...",
      all: "Tümü",
      aerospace: "Havacılık",
      ai: "Yapay Zeka",
      robotics: "Robotik",
  ...
  ar: {
    ...
    hero: {
      ...
      discover: "اكتشف المسابقات",
      watch: "شاهد الفيديو"
    },
    filters: {
      title: "المسابقات",
      subtitle: "اكتشف وتقدم لمسابقات التكنولوجيا.",
      searchPlaceholder: "بحث عن مسابقات...",
      all: "الكل",
      aerospace: "الفضاء",
      ai: "الذكاء الاصطناعي",
      robotics: "الروبوتات",
    ...
    card: {
      ...
      applicationsClosed: "التطبيقات مغلقة",
      comingSoon: "قريباً",
